    ...
    <div className="page-container">
      ...
      <section className="about-values">
        ...
        <div className="value-card">
          <h3>Integrity</h3>
          <p>In Giakanja Boys we instill integrity one child at a time. Every student is equipped with values that drive integrity.</p>
        </div>
        <div className="value-card">
          <h3>Godliness</h3>
          <p>We ensure that each child is equipped with religious values, making them able to fit into any religious society.</p>
        </div>
        <div className="value-card">
          <h3>Teamwork</h3>
          <p>With teamwork, all students are well equipped to work collaboratively, producing students who can succeed in organizations.</p>
        </div>
        <div className="value-card">
          <h3>Professionalism</h3>
          <p>Professionalism is highly valued. We create responsible citizens who can work to improve society.</p>
        </div>
        <div className="value-card">
          <h3>Social Responsibility</h3>
          <p>Every student is a responsible contributor to society with strong social skills.</p>
        </div>
        <div className="value-card">
          <h3>Courtesy</h3>
          <p>Courtesy ensures that students are responsible, polite, and conscientious in everything they do.</p>
        </div>
      </section>
